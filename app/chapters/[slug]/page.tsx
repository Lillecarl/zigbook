...
type ChapterParams = Promise<{ slug: string }>
...
export default async function ChapterPage({
  ...
  const chapters = await getAllChapters()
  const currentChapter = chapters.find(c => c.id === slug)
        ...
        <div className="flex flex-1 w-full min-h-0 overflow-hidden">
          <main className="flex-1 min-h-0 px-4 sm:px-6 lg:px-10 py-6 lg:py-10 w-full overflow-y-auto">
            <div className="mx-auto w-full max-w-4xl space-y-6 lg:space-y-8">
              ...
              {/* Contribute callout */}
              <ContributeCallout chapterId={slug} />

              {/* Chapter Navigation */}
              <ChapterNav currentChapterId={slug} chapters={chapters} />
