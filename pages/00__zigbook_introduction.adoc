...
. *No hidden control flow.* The compiler never injects allocators, goroutines, or implicit destructors. Machine code corresponds directly to what you wrote. When you read Zig, you know exactly what will execute. link:https://ziglang.org/documentation/master/#Control-Flow[#Control-Flow]
